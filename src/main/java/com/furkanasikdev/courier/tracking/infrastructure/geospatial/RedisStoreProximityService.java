package com.furkanasikdev.courier.tracking.infrastructure.geospatial;
...
@Slf4j
public class RedisStoreProximityService {
	...
	public List<GeoResult<RedisGeoCommands.GeoLocation<String>>> findNearbyStores(Location location) {
		...
		log.debug("Found {} nearby stores for coordinates ({}, {})", results.getContent().size(), location.lat(), location.lng());
